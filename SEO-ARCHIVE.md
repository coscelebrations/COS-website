# SEO Archive - Historical Session Notes

This file contains historical SEO session notes from December 2025 and earlier.
For current work, see `SEO.md`. For rules, see `~/CLAUDE.md`.
